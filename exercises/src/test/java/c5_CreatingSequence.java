...
public class c5_CreatingSequence {
	 ...
	 * Generate é para emissões síncronas e one-by-one:
	 * https://projectreactor.io/docs/core/release/reference/coreFeatures/programmatically-creating-sequence.html#producing.generate
	 * Create é mais avançado e para emissões assíncronas, podendo emitir mais de um por vez, com múltiplos producers por vez:
	 ...
	 * No push somente um producer por vez
	 * https://projectreactor.io/docs/core/release/reference/coreFeatures/programmatically-creating-sequence.html#producing.create
     */
    @Test
