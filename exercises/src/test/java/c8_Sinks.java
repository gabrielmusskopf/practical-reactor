    ...
    public void emit_failure() {
        ...
        for (int i = 1; i <= 50; i++) {
            ...
            new Thread(() -> sink.emitNext(finalI, (signalType, emitResult) ->
					Sinks.EmitResult.FAIL_NON_SERIALIZED.equals(emitResult))).start();
			// Ou usar https://projectreactor.io/docs/core/release/api/reactor/core/publisher/Sinks.EmitFailureHandler.html#busyLooping-java.time.Duration-
        }
